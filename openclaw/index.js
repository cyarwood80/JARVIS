...
client.on('message_create', async (msg) => {
    ...
    // Only respond if message mentions "jarvis" or an active session is within 5 min window
    if (!isJarvis && !sessionActive) {
    ...
    // Save admin number so Jarvis knows who to push messages to
    ...
    try {
        console.log('[PROXY] Calling Jarvis 3-stage pipeline...');
...
// ==========================================
// PUSH API SERVER
// Listens for push requests from Jarvis core
// ==========================================
const app = express();
app.use(cors());
